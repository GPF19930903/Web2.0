            ...
            <Container fluid className="home-section" id="home">
                <Container className="home-content">
                    ...
                    <h1 className="NormalText" style={{ paddingTop: 20 }}>
                        <span className="ShiningText">My Intresets lie in</span>
                    ...
                    <div className="ListContainer">
                        <div className='itemContainer'>
                            <div className="title">
                                ...
                                <p className="subTitle"><img src={ liIcon } alt='li-icon' />Products</p>
                        ...
                        <div className='itemContainer'>
                            ...
                            <div className="title">
                                ...
                                <p className="subTitle"><img src={ liIcon } alt='li-icon' />AR & VR in Computer Vision</p>
                                <p className="subTitle"><img src={ liIcon } alt='li-icon' />Robotic Control</p>
                            </div>
                        </div>
                        <div className='itemContainer'>
                            <div className="title">
